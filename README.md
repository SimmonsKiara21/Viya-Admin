...
- **Edit** on an open talent file changes name, nickname, age, email, phone, start date, class time, and their enrollment tag. Status is also on the open file — Pending to Current after a deposit, or Overdue, Paused, Collections.
