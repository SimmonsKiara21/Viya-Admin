...
- **Contacts** is everyone else. Tags match the Google Contacts lists: **Current Student**, **Active Subscribers**, **SEPTEMBER PHOTOSHOOT LIST**, and **MODEL SOURCE NOVEMBER**. **Newsletter** is subscribers only — leftover Newsletter labels and other lists do not put someone on that tab. Contact files say Contact, not Prospect. People with no list stay under All contacts.
