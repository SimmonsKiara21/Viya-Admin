  ...
  return (
    <div>
      <PageHeader
        eyebrow="Leads"
        title="Contacts"
        description="Lists match Google Contacts. Newsletter is the same people as Active Subscribers."
        actions={
      ...
      {contacts.length === 0 ? (
        <EmptyState
          ...
          description={
            category === "newsletter"
              ? "Newsletter matches Active Subscribers. Leftover Newsletter tags are gone."
