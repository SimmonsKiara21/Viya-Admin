  ...
  return (
    <div>
      <PageHeader
        eyebrow="Outreach"
        title="Text & Gmail"
        description="Texts go out through the academy Textla line when it is connected. Current students, overdue talent, subscriber overdue, and subscribers each have their own group."
      />
