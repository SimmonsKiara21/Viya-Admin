...
function mergeStudent(keeper: Student, extra: Student): Student {
  ...
  return {
    ...
    deskLocks: {
      ...
      highlight: Boolean(keeper.deskLocks?.highlight || extra.deskLocks?.highlight),
    },
    manualHighlight: keeper.manualHighlight !== "none" ? keeper.manualHighlight : extra.manualHighlight,
    subscriptionRunDate: keeper.subscriptionRunDate || extra.subscriptionRunDate,
